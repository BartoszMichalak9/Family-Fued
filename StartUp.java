...
/*
 * The startup class creates a GUI menu for the user to start the Family Feud Start menu.
 * The user must press start when they are ready to start the game.
 */
public class StartUp extends JFrame implements ActionListener
{
   ...
   public void actionPerformed(ActionEvent ae)
   {
      ...
      {
         //Creates a PlayerChoice object so that the next class can be started and the players playing can insert their names
         new PlayerChoice();
